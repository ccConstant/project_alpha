        ...
        <div id="page">
            ...
            <div class="mme_planning_annual_table">
                <b-row>
                    ...
                    <b-col cols="1" class="mme_planning_annual_periodicity_title">
                        Freq.
                    </b-col>
                </b-row>
                    ...
                    <div v-if="mme.verifications.length!=0">
                        <div v-for="(mme_verif,index2) in mme.verifications" :key="index2">
                            <b-row>
                                ...
                                <b-col  v-if="maintenancePlanned(periode[3].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>
                                ...
                                <b-col v-if="maintenancePlanned(periode[7].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[8].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[9].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[10].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[11].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[12].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[13].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[14].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[15].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[16].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[17].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[18].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[19].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[20].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[21].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[22].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>

                                <b-col v-if="maintenancePlanned(periode[23].id,mme_verif.verif_nextDate)" cols="4" class="mme_planning_annual_plannification_date_value_color">
                                </b-col>
                                <b-col v-else cols="4" class="mme_planning_annual_plannification_date_value">
                                </b-col>
