            ...
            <form class="container curMtnOp-form"  @keydown="clearError">
                ...
                <div v-if="this.addSucces==false ">
                    ...
                    <div v-if="this.curMtnOp_id==null ">
                        <SaveButtonForm :is_op="true" :Errors="errors.curMtnOp_validate" @add="addMmeCurMtnOp" @update="updateMmeCurMtnOp" :consultMod="this.isInConsultMod" :savedAs="curMtnOp_validate" :desactiveValidated="true"/>
                    </div>
                    <div v-else-if="this.curMtnOp_id!==null">
                        <SaveButtonForm :is_op="true" :Errors="errors.curMtnOp_validate"  @add="addMmeCurMtnOp" @update="updateMmeCurMtnOp" :consultMod="this.isInConsultMod" :modifMod="this.modifMod" :savedAs="curMtnOp_validate" :desactiveValidated="true"/>
                    </div>
