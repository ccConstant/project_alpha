        ...
        <div id="page">
            ...
            <div class="mme_top_infos">
                ...
                <div class="mme_revued_by">
                    <p>Technical Review <b class="text-primary">{{ mme_idCard.mme_technicalVerifier_firstName }}
                        {{ mme_idCard.mme_technicalVerifier_lastName }} </b></p>
                </div>

                <div class="mme_approuved_by">
                    <p>Quality Review <b class="text-primary">{{ mme_idCard.mme_qualityVerifier_firstName }}
                        {{ mme_idCard.mme_qualityVerifier_lastName }} </b></p>
                </div>
