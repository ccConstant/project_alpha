                    ...
                    <li :class="'element'+index%2" class="list-group-item">
                        ...
                        <div class="mme_list_option">
                            ...
                            <a v-if="list.alreadyValidatedTechnical===true && list.alreadyValidatedQuality===true">Statut
                                : Approved</a>
                            <a href="#" @click="reformMME(list.id)">Reform</a>
                            <router-link :to="{name:'mme_url_lifesheet_pdf',params:{id: list.id} }">Generate PDF
                            </router-link>
                        </div>
                    </li>
                </div>
            </ul>
            <jw-pagination :items="filterByTerm" :pageSize=10 class="mme_list_pagination"
