...
<template>
    <div class="equipmentprvMtnOpRlz">
        ...
        <EquipmentPrvMtnOpRlzForm :is="component.comp" v-for="(component, key) in components" :id="component.id"
                                  :key="component.key" ref="ask_prvMtnOpRlz_data"
                                  ...
                                  :prvMtnOp_description_prop="component.prvMtnOp_description"
                                  :prvMtnOp_id_prop="component.prvMtnOp_id"
                                  :prvMtnOp_number_prop="component.prvMtnOp_number"
                                  :prvMtnOp_protocol_prop="component.prvMtnOp_protocol"
                                  :reportNumber="component.reportNumber" :startDate="component.startDate" :state_id="data_state_id"
                                  :validate="component.validate"
                                  @addSucces="addSucces()" @deletePrvMtnOpRlz="getContent(key)"
        />
