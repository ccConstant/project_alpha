...
<template>
    <div :class="divClass">
        ...
        <div v-else>
            <div v-if="mme_id!=null && isInConsultMod"> Consult all the information about the MME
                <router-link :to="{name:'url_mme_consult',params:{id:this.mme_id} }"> here</router-link>
            </div>
            <div v-if="mme_id!=null && isInModifMod"> Update all the information about the MME
    ...
    methods: {
        ...
        addEquipmentMme(savedAs, reason, lifesheet_created) {
            ...
            if (!this.modifMod) {
                ...
                /*else the user is in modification mode, we set the id with the value of equipment_id_update*/
            } else {
        ...
        addInfoMmeAlreadyCreated(value, reason, lifesheet_created) {
            ...
            let id;
            /*If the user is in the modification mode, we set the id with the value of equipment_id_add*/
            if (!this.modifMod) {
                id = this.equipment_id_add
                /*Else if the user is not in the modification mode, we set the id with the value of equipment_id_update*/
            } else {
                id = this.equipment_id_update;
            }
            /*We test if a life sheet has been already created*/
        ...
        /*Function for deleting a component from the view and the database*/
