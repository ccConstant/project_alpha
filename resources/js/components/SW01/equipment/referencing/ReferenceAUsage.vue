...
<template>
    <div class="equipmentUsg">
        ...
        <EquipmentUsgForm :is="component.comp" v-for="(component, key) in components" :id="component.id"
                          :key="component.key" ref="ask_usg_data" :consultMod="isInConsultMod"
                          :divClass="component.className" :eq_id="data_eq_id"
                          :modifMod="isInModifMod" :precuation="component.precaution" :reformBy="component.reformBy"
                          :reformDate="component.reformDate"
                          :reformMod="isInReformMod" :type="component.type" :validate="component.validate"
