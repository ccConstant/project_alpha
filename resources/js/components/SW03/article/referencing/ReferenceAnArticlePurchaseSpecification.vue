...
<template>
    <div class="articlePurchaseSpecification">
        <h2 class="titleForm">Article Purchase Specification(s) </h2>
...
export default {
    ...
    methods: {
        ...
        addImportedComponent(purchaseSpecification_requiredDoc,purchaseSpecification_className, id) {
            this.components.push({
                comp: 'ArticlePurchaseSpecificationForm',
                key: this.uniqueKey++,
