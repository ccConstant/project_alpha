<template>
      <div class="MmeCurMtnOp" >
        ...
        <!--The emitted deleteCurMtnOp is catched here and call the function getContent -->
...
export default {
    ...
    methods:{
        ...
        //Function for adding imported curative maintenance operation form with his data
        ...
        importCurMtnOp(){
            for (const curMtnOp of this.curMtnOps) {
                var className="importedCurMtnOp"+curMtnOp.id
