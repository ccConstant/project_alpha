...
/**
 * Filename : PrecautionController.php
 * Creation date : 21 Jun 2021
 * Update date : 27 Jun 2023
 * This file is used to link the view files and the database that concern the Precaution table.
 * For example : send the fields of the precaution, add a new field...
 */
