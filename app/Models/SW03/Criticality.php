...
class Criticality extends Model
{
    ...
    protected $fillable = ['crit_artCriticality, crit_artMaterialContactCriticality', 'crit_artMaterialFunctionCriticality', 'crit_artProcessCriticality', 'crit_qualityApproverId', 'crit_technicalReviewerId', 'crit_signatureDate', 'crit_validate', 'crit_remarks', 'compFam_id', 'consFam_id', 'rawFam_id'] ;
