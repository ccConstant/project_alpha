...
class FunctionalTest extends Model
{
    ...
    protected $fillable = ['funcTest_severityLevel', 'funcTest_levelOfControl', 'funcTest_expectedMethod', 'funcTest_expectedValue', 'incmgInsp_id', 'funcTest_name', 'funcTest_unitValue', 'funcTest_desc', 'funcTest_sampling', 'funcTest_specDoc'];
