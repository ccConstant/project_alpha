...
* migration file named "2023_05_31_120526_create_cons_family_members_table.php" in Database>migrations."
*
*/
...
class ConsFamilyMember extends Model
{
    ...
    protected $fillable = [
        'consMb_dimension',
        'consMb_technicalReviewerId',
        'consMb_qualityApproverId',
        'consMb_signatureDate',
        'consSubFam_id',
        'consMb_design',
        'consMb_sameValues'
    ] ;

    /*Define the relation between a cons_family_member and the cons_sub_family which he is linked:
    a cons_family_member can be linked to only one cons_family*/
