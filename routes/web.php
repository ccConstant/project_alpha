...
Route::post('/artSubFam/enum/storageCondition/link/{id}', [EnumStorageConditionController::class, 'link_enum_storageCondition_subFam']);
Route::post('/artSubFam/enum/storageCondition/unlink/{type}/{id}', [EnumStorageConditionController::class, 'unlink_enum_storageCondition_subFam']);
Route::post('/artSubFam/storageCondition/update/{id}', [EnumStorageConditionController::class, 'update_storageCondition_linked_subFam']);
