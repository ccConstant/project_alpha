...
/*
* Filename : 2022_06_07_142255_create_mme_table.php
...
class CreateMmeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mme', function (Blueprint $table) {
            $table->id();
